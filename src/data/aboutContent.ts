export const aboutPageData = {
  ...
  timeline: [
    {
      year: '2024',
      title: 'The club forms',
      body: 'A handful of students start meeting to work through ML papers and course material that no class was covering yet.',
    },
    {
      year: '2025',
    ...
    {
      year: '2025',
      title: 'Industry comes to campus',
      body: 'Microsoft and other partners join us for talks and demos, and members begin landing AI-focused internships.',
    },
    {
      year: 'Now',
